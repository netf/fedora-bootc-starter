    ...
    steps:
      ...
      - name: Verify system state in VM
        run: |
          ...
          $ROOT_SSH 'systemctl is-system-running || true'   # may report degraded, OK
